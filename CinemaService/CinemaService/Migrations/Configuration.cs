namespace CinemaService.Migrations
{
   ...
   internal sealed class Configuration : DbMigrationsConfiguration<CinemaService.Models.ApplicationDbContext>
   {
      ...
      protected override void Seed(CinemaService.Models.ApplicationDbContext context)
      {
         ...
         Theater th1 = context.Theaters.Find(1);
         Theater th2 = context.Theaters.Find(2);
         Theater th3 = context.Theaters.Find(3);

         ProjectionType pt1 = context.ProjectionTypes.Find(1);
         ProjectionType pt2 = context.ProjectionTypes.Find(2);
         ProjectionType pt3 = context.ProjectionTypes.Find(3);

         th1.ProjectionTypes.Add(pt1);
         th1.ProjectionTypes.Add(pt2);
         th1.ProjectionTypes.Add(pt3);

         th2.ProjectionTypes.Add(pt1);
         th2.ProjectionTypes.Add(pt2);

         th3.ProjectionTypes.Add(pt3);
